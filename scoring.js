...
//------モジュールスコープ変数s--------
  ...
  answer = [{ans  : [1,3],       score : 2, kind : 0},
             {ans : [3],         score : 2, kind : 0},
             {ans : [1],         score : 2, kind : 0},
             {ans : [4],         score : 3, kind : 0},
             {ans : [2],         score : 2, kind : 0},
             {ans : [2,2,7],     score : 1, kind : 0},
             {ans : [2],         score : 3, kind : 0},

             {ans : [1,4],       score : 3, kind : 0},
             {ans : [6],         score : 3, kind : 0},
             {ans : [5,1,0],     score : 3, kind : 0},
             {ans : [6],         score : 3, kind : 0},
             ...
             {ans : [1],         score : 3, kind : 0},
             {ans : [0],         score : 3, kind : 0},
             {ans : [5],         score : 3, kind : 0},

             {ans : [0,2,3],     score : 3, kind : 0},
             {ans : [5],         score : 3, kind : 0},
             {ans : [2],         score : 3, kind : 0},
             {ans : [2,3],       score : 3, kind : 1},

             {ans : [5,8],       score : 2, kind : 0},
             {ans : [5,3],       score : 2, kind : 0},
             {ans : [4,5,4,9,7,2,1,0,9,9], score : 3, kind : 0},
             {ans : [9,5,8,7],   score : 2, kind : 0}
/*             {ans : [7,1,2],     score : 3, kind : 0}, 問題用紙作成ミスによりここは人間が採点する
             {ans : [0],         score : 2, kind : 0},
             {ans : [1,2,7,3],   score : 3, kind : 0},
             {ans : [4],         score : 3, kind : 0}*/
           ];
