...
//------モジュールスコープ変数s--------
  ...
  answer = [{ans  : [2],         score : 1, kind : 0},
             {ans : [4],         score : 1, kind : 0},
             {ans : [0],         score : 1, kind : 0},
             {ans : [2],         score : 2, kind : 0},
             {ans : [2],         score : 2, kind : 0},
             {ans : [1],         score : 3, kind : 0},

             {ans : [0],         score : 2, kind : 0},
             {ans : [1],         score : 2, kind : 0},
             {ans : [2],         score : 3, kind : 0},
             {ans : [1],         score : 3, kind : 0},

             {ans : [1,3],       score : 2, kind : 0},
             {ans : [6],         score : 2, kind : 0},
             {ans : [1,5],       score : 2, kind : 0},
             {ans : [2,7,1,0,2,1,9,0], score : 3, kind : 0},
             {ans : [6,0],       score : 3, kind : 0},
             {ans : [3],         score : 3, kind : 0},

             {ans : [1],         score : 2, kind : 0},
             {ans : ['-',2],     score : 2, kind : 0},
             {ans : [3,3,2],     score : 2, kind : 0},
             {ans : ['-',2],     score : 3, kind : 0},
             {ans : [3,4],       score : 3, kind : 0},
             {ans : [1],         score : 3, kind : 0},

             {ans : [1,3],       score : 1, kind : 0},
             {ans : [1,2],       score : 1, kind : 0},
             {ans : [3,2],       score : 2, kind : 0},
             {ans : [2,3],       score : 2, kind : 0},
             {ans : [5],         score : 2, kind : 0},
             {ans : [5],         score : 2, kind : 0},
             {ans : [5,1],       score : 2, kind : 0},
             {ans : [5,1,1,2],   score : 2, kind : 0},
             {ans : [5,1,1,2],   score : 2, kind : 0},

             {ans : ['-',1,2,1], score : 2, kind : 0},
             {ans : [2],         score : 1, kind : 0},
             {ans : [0],         score : 1, kind : 0},
             {ans : [2,9],       score : 2, kind : 0},
             {ans : ['-',1,9],   score : 2, kind : 0},
             {ans : [1],         score : 2, kind : 0},
             {ans : [8,9],       score : 2, kind : 0},

             {ans : [2],         score : 2, kind : 0},
             {ans : ['-',7,5],   score : 2, kind : 0},
             {ans : [6,5],       score : 2, kind : 0},
             {ans : [2,1,5,5],   score : 2, kind : 0}
           ];
